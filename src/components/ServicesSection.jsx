...
function ServicesSection() {
  ...
  return (
    ...
    >
      ...
      <div className="relative z-20 mx-auto flex h-full max-w-[1880px] flex-col px-6">
        <div className="pt-1 text-center">
          <h2 className="mx-auto mt-2 max-w-[760px] text-3xl font-semibold leading-tight text-white md:text-5xl">
            serviços e soluções
        ...
        <div className="relative flex flex-1 items-center justify-center pt-6">
          ...
          <div className="relative mx-auto flex w-full max-w-[960px] items-center justify-center">
            <button
              type="button"
              onClick={goPrev}
              className="absolute left-0 z-30 flex h-11 w-11 items-center justify-center rounded-full border border-[#1193E6]/18 bg-[#1193E6]/[0.06] text-[#B6E9FF] backdrop-blur-md transition hover:scale-105 hover:border-[#25B7F3]/30"
            >
              <svg
                viewBox="0 0 24 24"
                className="h-5 w-5"
            ...
            <div className="w-full px-14">
              <AnimatePresence mode="wait">
                <motion.div
                  ...
                  className="relative overflow-hidden rounded-[28px] border border-[#1193E6]/16 bg-[#1193E6]/[0.05] px-5 py-5 backdrop-blur-xl md:px-6 md:py-6"
                  style={{
                    boxShadow:
                ...
                >
                  ...
                  <div className="relative z-10 grid min-h-[285px] items-stretch gap-5 md:grid-cols-[0.9fr_1.1fr]">
                    <div className="flex flex-col justify-center">
                      <span className="inline-flex w-fit rounded-full border border-[#25B7F3]/20 bg-[#1193E6]/10 px-3 py-1.5 text-[11px] uppercase tracking-[0.28em] text-[#A9E4FF]/70">
                        {activeService.tag}
                      </span>

                      <h3 className="mt-3 text-[2.2rem] font-semibold leading-tight text-white md:text-[2.5rem]">
                        {activeService.title}
                      </h3>

                      <p className="mt-3 text-[15px] leading-7 text-cyan-50/75 md:text-base">
                      ...
                      <div className="mt-5 flex flex-wrap gap-2.5">
                        {activeService.points.map((point) => (
                          <span
                            key={point}
                            className="rounded-full border border-[#1193E6]/14 bg-[#1193E6]/[0.05] px-3 py-1.5 text-[11px] uppercase tracking-[0.22em] text-[#D6F3FF]/70 md:text-xs"
                          >
                            {point}
                          </span>
                        ))}
                    ...
                    <div className="flex h-full items-stretch justify-center md:justify-end">
                      <div className="relative h-full min-h-[285px] w-full overflow-hidden rounded-[22px] border border-[#1193E6]/18 bg-[#1193E6]/[0.06] shadow-[0_0_24px_rgba(17,147,230,0.14)]">
                        <img
            ...
            <button
              type="button"
              onClick={goNext}
              className="absolute right-0 z-30 flex h-11 w-11 items-center justify-center rounded-full border border-[#1193E6]/18 bg-[#1193E6]/[0.06] text-[#B6E9FF] backdrop-blur-md transition hover:scale-105 hover:border-[#25B7F3]/30"
            >
              <svg
                viewBox="0 0 24 24"
                className="h-5 w-5"
