...
function Navbar({ activeSection = 0, transitionKey = 0, onNavigate }) {
  ...
  return (
    <header className="absolute top-0 left-0 z-50 w-full">
      <div className="mx-auto flex max-w-6xl items-center justify-between px-5 pt-3 md:px-8">
          ...
          >
            ...
            >
              <motion.img
                ...
                className="h-[64px] w-auto object-contain sm:h-[76px] md:h-[88px] xl:h-[96px]"
              />
            </motion.button>
            ...
            <motion.button
              ...
              className="group relative inline-flex items-center justify-center overflow-hidden rounded-full border border-cyan-300/45 bg-cyan-400 px-4 py-2 text-xs font-bold text-black transition duration-300 hover:shadow-[0_0_36px_rgba(34,211,238,0.42)] sm:px-5 sm:py-2.5 sm:text-sm"
            >
